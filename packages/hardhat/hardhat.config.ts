...
// Alternative: Use public RPC if INFURA_API_KEY is not set or is the default placeholder
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: {
      ...
      chainId: 11155111,
      // Use custom RPC URL if set, otherwise fallback to Infura, or public node
      url:
