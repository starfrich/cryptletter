...
export const ThemeController = () => {
  ...
  if (!mounted) {
    return <div className="w-6 h-6 animate-pulse bg-base-300 rounded"></div>;
  }
  ...
  return (
    <label className="swap swap-rotate">
      ...
      <input type="checkbox" className="theme-controller" value="night" checked={isDark} onChange={handleToggle} />
